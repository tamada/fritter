...
public class NoSystemExitValidatorTest {
    private static Validator validator;

    @BeforeAll
    public static void setUp() {
        ValidatorService service = new NoSystemExitValidatorService();
        validator = service.build(Parameter.EMPTY);
    }

    @DisplayName("NoSystemExitValidator StatsValues.java")
    @Test
    public void case1() {
    ...
    @DisplayName("NoSystemExitValidator Stats.java")
    @Test
    public void case2() {
    ...
    @DisplayName("NoSystemExitValidator Primes.java")
    @Test
    public void case3() {
